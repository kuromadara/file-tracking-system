...
@section('content')
    <h2 class="text-2xl font-semibold text-gray-800 mb-4">Create Department</h2>
    <form action="{{ route('departments.store') }}" method="POST">
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Create Department</button>
    </form>
@endsection
