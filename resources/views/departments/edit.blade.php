...
@section('content')
    <h2 class="text-2xl font-semibold text-gray-800 mb-4">Edit Department</h2>
    <form action="{{ route('departments.update', $department->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $department->description }}</textarea>
        </div>
